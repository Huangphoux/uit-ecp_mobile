...
= Mini‑Sprint Scrum — Biên bản tóm tắt (Sprint 3)
...
- **Khang / Hiệp (SMs):** Cần thống nhất naming convention cho cả FE & BE.
- **Huy / Tùng (Dev):** API response chưa đồng nhất giữa các module.
- **Phúc (PO):** Cần cập nhật lại timeline Sprint do một số thành viên bận lịch học.
