...
= Level of Precision:
- Dòng mục chi tiết (line-item): làm tròn đến 100.000 ₫.
- Lao động: làm tròn đến 1 giờ.
- Tổng chi phí hạng mục: làm tròn đến 1.000.000 ₫.
- Báo cáo tóm tắt: làm tròn đến 10.000.000 ₫ khi trình bày cho sponsor.
...
- Mẫu file: Excel workbook: Cost_Report_<YYYYMM>.xlsx với sheet: Summary, Detail by WBS, Vendor Quotes, Forecast (EAC/ETC).
...
= AI Usage Note
Gõ file doc với các tiêu đề của từng mục cũng như vẽ sẵn các bảng chừa các ô dữ liệu. Sau đó, đưa file cho AI để nhờ ghi thử 
thông tin sau đó dựa vào để sửa. Các tên người dùng, tập đoàn được giữ lại. Trong khi đó, các thông tin về chức năng được sửa lại 
